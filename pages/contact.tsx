...
const Contact = ({ contactText = '', formspreeEndpoint }: ContactProps) => {
  ...
  return (
    <Section className={styles.contact}>
      <Meta
        title="Contact"
        description="Do you have a project in mind? Or need help in your company? If so, feel free to contact me with your query and I will get in touch as soon as possible."
      />
